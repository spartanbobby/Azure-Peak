...
/obj/item/blueprint/mace_mushroom/examine(mob/user)
	...
	. += span_notice("Originally conceived of by the drow weaponsmith, Lithmyc is a liquid-solid metal made out of a particular metallic mushroom. This mushroom can SOMETIMES be found in the Underdark.")

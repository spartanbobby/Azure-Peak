...
/obj/structure/roguemachine/contractledger/get_mechanics_examine(mob/user)
	...
	. += span_info("A rumor or commission may be <b>withdrawn</b> from the Issued tab [QUEST_ISSUER_CANCEL_WINDOW / (1 MINUTES)] minutes after it was issued or last taken up, so long as the contract has not begun. Its cost is refunded in full. Postings that lapses are refunded automatically.")

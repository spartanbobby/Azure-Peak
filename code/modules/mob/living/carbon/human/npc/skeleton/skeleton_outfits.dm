...
/datum/outfit/job/roguetown/skeleton/npc/supereasy/pre_equip(mob/living/carbon/human/H)
	...
	H.adjust_skillrank_up_to(/datum/skill/combat/shields, 1, TRUE)
...
/datum/outfit/job/roguetown/skeleton/npc/pirate/pre_equip(mob/living/carbon/human/H)
	...
	H.adjust_skillrank_up_to(/datum/skill/combat/unarmed, 2, TRUE)
	H.adjust_skillrank_up_to(/datum/skill/combat/wrestling, 2, TRUE)
	H.adjust_skillrank_up_to(/datum/skill/misc/swimming, 4, TRUE) //YARR
	H.adjust_skillrank_up_to(/datum/skill/misc/climbing, 2, TRUE)
...
/datum/outfit/job/roguetown/skeleton/npc/hard/pre_equip(mob/living/carbon/human/H)
	...
	if(skeletonclass == 1) // Khopesh Knight
		...
		H.adjust_skillrank_up_to(/datum/skill/misc/swimming, 4, TRUE) //Needed at expert else we lose our duel blades by falling over in water cause heavy
		cloak = /obj/item/clothing/cloak/tabard/toga/lich
		...
		H.adjust_skillrank_up_to(/datum/skill/misc/swimming, 2, TRUE) //Tanky but falls over in water
		wrists = /obj/item/clothing/wrists/roguetown/bracers/aalloy
		pants = /obj/item/clothing/under/roguetown/platelegs/aalloy
		shoes = /obj/item/clothing/shoes/roguetown/boots/aalloy
		neck = /obj/item/clothing/neck/roguetown/gorget/aalloy

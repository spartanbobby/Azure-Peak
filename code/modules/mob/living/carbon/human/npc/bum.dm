...
/datum/outfit/job/roguetown/bum_npc/pre_equip(mob/living/carbon/human/H)
	..()
	H.adjust_skillrank_up_to(/datum/skill/combat/knives, rand(0,3), TRUE) // Exceedingly trash mobs, ...sometimes
	H.adjust_skillrank_up_to(/datum/skill/combat/polearms, rand(0,3), TRUE)
	H.adjust_skillrank_up_to(/datum/skill/combat/staves, rand(0,3), TRUE)
	H.adjust_skillrank_up_to(/datum/skill/combat/maces, rand(0,3), TRUE)
	H.adjust_skillrank_up_to(/datum/skill/combat/axes, rand(0,3), TRUE)
	H.adjust_skillrank_up_to(/datum/skill/combat/unarmed, rand(0,3), TRUE)
	H.adjust_skillrank_up_to(/datum/skill/combat/wrestling, rand(0,3), TRUE)
	H.adjust_skillrank_up_to(/datum/skill/misc/swimming, rand(2,5), TRUE)
	H.adjust_skillrank_up_to(/datum/skill/misc/climbing, rand(2,5), TRUE)

...
#define TRAIT_WARLOCK "Rituos Warlock" // Cancels out weapon w/ casting penalities, exclusive to rituos
//Baotha
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_WARLOCK = span_dead("The greater works have re-adjusted my arcane conduits, I no longer suffer fatigue drawbacks from casting with a weapon."),

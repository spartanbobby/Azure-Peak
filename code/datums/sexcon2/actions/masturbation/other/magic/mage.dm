...
/datum/sex_action/masturbate/other/magejob/on_start(mob/living/carbon/human/user, mob/living/carbon/human/target)
	...
	user.visible_message(span_warning("[user] starts [do_subtle ? "subtly " : ""]jerking [target]'s pintle off with arcyne..."), vision_distance = (do_subtle ? 2 : DEFAULT_MESSAGE_RANGE))
